...
namespace VendasWEB.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(WEBContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            if (_context.Departament.Any() || _context.Seller.Any() || _context.Sales.Any())
            {
                return;
            }
            ...
            SalesRecord r27 = new SalesRecord(27, new DateTime(2018, 10, 13), 9000.0, SaleStatus.CANCELED, s1);
